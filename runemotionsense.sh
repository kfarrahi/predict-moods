...
python testallinputs.py data/binaryPredNextWeekMedian.txt 2 dffn 3 100
...
python testallinputs.py data/binaryPredNextWeekMedian.txt 2 dffn 3 25
...
python testallinputs.py data/binaryPredNextWeekMedian.txt 2 dffn 3 50
...
python testallinputs.py data/binaryPredNextWeekAvg.txt 2 dffn 3 25
...
python testallinputs.py data/binaryPredNextWeekIncDrop.txt 2 dffn 3 25
...
python testallinputs.py data/binaryPredNextWeekMedian_equal.txt 3 dffn 3 25
...
python testallinputs.py data/binaryPredNextWeekAvg_equal.txt 3 dffn 3 25
...
python testallinputs.py data/binaryPredNextWeekIncDropEqual.txt 3 dffn 3 25
